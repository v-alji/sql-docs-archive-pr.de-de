...
-   [Ableiten von Beziehungen](#detection)  
...
|CustomerID|Name|EMail|DiscountRate|OrderID|OrderDate|Product (Produkt)|Menge|  
|----------------|----------|-----------|------------------|-------------|---------------|-------------|--------------|  
...
|[CustomerID]|OrderID|OrderDate|Product (Produkt)|Menge|  
|--------------------|-------------|---------------|-------------|--------------|  
...
|Beziehung|type|Suchspalte|Spalte|  
|------------------|----------|-------------------|------------|  
...
### <a name="one-relationship-for-each-source-column"></a>Eine Beziehung pro Quellspalte  
 ...
 Mithilfe einer DAX-Formel in einer berechneten Spalte kann problemlos eine Kopie einer Spalte mit exakt gleichen Werten erstellt werden. Weitere Informationen finden Sie unter [Erstellen einer berechneten Spalte &#40;SSAS – tabellarisch&#41;](ssas-calculated-columns-create-a-calculated-column.md).  
...
### <a name="compatible-data-types"></a>Kompatible Datentypen  
 Die Datentypen in der Quellspalte und Suchspalte müssen kompatibel sein. Weitere Informationen zu Datentypen finden Sie unter [Unterstützte Datentypen &#40;SSAS – tabellarisch&#41;](data-types-supported-ssas-tabular.md).  
