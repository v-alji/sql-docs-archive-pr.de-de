...
###  <a name="sample-query-1-retrieving-periodicity-hints-for-the-model"></a><a name="bkmk_Query1"></a> Beispielabfrage 1: Abrufen von Periodizitätshinweisen für das Modell  
...
###  <a name="sample-query-2-retrieving-the-equation-for-an-arima-model"></a><a name="bkmk_Query2"></a> Beispielabfrage 2: Abrufen der Gleichung für ein ARIMA-Modell  
...
###  <a name="sample-query-3-retrieving-the-equation-for-an-artxp-model"></a><a name="bkmk_Query3"></a>Beispiel Abfrage 3: Abrufen der Gleichung für ein ARTxp-Modell  
...
###  <a name="understanding-the-behavior-of-replace-and-extend-operations"></a><a name="bkmk_ReplaceExtend"></a> Grundlegendes zum Verhalten von Vorgängen zum Ersetzen und Erweitern  
...
###  <a name="making-predictions-with-replace_model_cases"></a><a name="bkmk_REPLACE"></a>Treffen von Vorhersagen mit REPLACE_MODEL_CASES  
