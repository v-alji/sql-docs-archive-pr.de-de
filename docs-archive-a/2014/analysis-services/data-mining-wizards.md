...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Erstellen einer OLAP-Mining Struktur](data-mining/create-an-olap-mining-structure.md)   
 [Erstellen einer relationalen Mining Struktur](data-mining/create-a-relational-mining-structure.md)   
 [Erstellen einer neuen relationalen Mining Struktur](data-mining/create-a-new-relational-mining-structure.md)   
