...
|---------------------------------|-----------------|  
|BigInt|Eine 64-Bit-Ganzzahl mit Vorzeichen. Dieser Datentyp wird dem Int64-Datentyp in Microsoft [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] und dem DBTYPE_I8-Datentyp in der OLE DB zugeordnet.|  
...
|Integer|Eine 32-Bit-Ganzzahl mit Vorzeichen. Dieser Datentyp wird dem Int32-Datentyp in [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] und dem DBTYPE_I4-Datentyp in der OLE DB zugeordnet.|  
...
|Eigenschaft|Kardinalität|type|BESCHREIBUNG|  
|--------------|-----------------|----------|-----------------|  
