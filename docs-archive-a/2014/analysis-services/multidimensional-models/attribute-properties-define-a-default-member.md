...
## <a name="specifying-the-default-member"></a>Festlegen des Standardelements  
 ...
 Wenn die `DefaultMember` Einstellung für ein Attribut leer ist und die- `IsAggregatable` Eigenschaft auf festgelegt ist `True` , ist das Standardelement das alle-Element. Wenn die- `IsAggregatable` Eigenschaft auf festgelegt ist `False` , ist das Standardelement das erste Element der ersten sichtbaren Ebene.  
