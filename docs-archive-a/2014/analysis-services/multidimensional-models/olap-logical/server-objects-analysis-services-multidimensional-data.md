...
## <a name="introducing-server-objects"></a>Einführung in Serverobjekte  
 Das <xref:Microsoft.AnalysisServices.Server> -Objekt stellt den Server und die Instanz von dar [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] , mit der Sie arbeiten möchten.  
