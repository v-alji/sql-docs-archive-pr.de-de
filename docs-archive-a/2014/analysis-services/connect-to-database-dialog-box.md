...
|Begriff|Definition|  
|----------|----------------|  
|**Verbindung mit vorhandener Datenbank herstellen**|Wählen Sie diese Option aus, um eine Verbindung mit einer vorhandenen Datenbank herzustellen. Klicken Sie auf der Liste vorhandener Datenbanken auf die Datenbank, zu der Sie eine Verbindung herstellen möchten.|  
