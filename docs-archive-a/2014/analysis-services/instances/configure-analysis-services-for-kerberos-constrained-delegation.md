...
##  <a name="configure-analysis-services-for-trusted-delegation"></a><a name="bkmk_delegate"></a> Konfigurieren von Analysis Services für die vertrauenswürdige Delegierung  
