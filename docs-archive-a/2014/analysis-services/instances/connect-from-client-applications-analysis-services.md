...
-   [Herstellen einer Verbindung mithilfe SQL Server Management Studio (SSMS)](#bkmk_SSMS)  
...
##  <a name="connect-using-sql-server-management-studio-ssms"></a><a name="bkmk_SSMS"></a> Herstellen einer Verbindung mithilfe von SQL Server Management Studio (SSMS)  
...
##  <a name="connect-using-excel"></a><a name="bkmk_excel"></a>Herstellen einer Verbindung mit Excel  
...
##  <a name="connect-using-sql-server-data-tools"></a><a name="bkmk_SSDT"></a>Verbindung über SQL Server Data Tools herstellen  
...
##  <a name="test-connections"></a><a name="bkmk_tshoot"></a>Testen von Verbindungen  
