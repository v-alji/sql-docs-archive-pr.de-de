...
|**Disconnect** (Trennen)|Trennt die Verbindung zwischen dem MDX-Abfrage-Editor und einer Instanz von [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .|  
...
|**Parse**|Überprüft die Syntax des ausgewählten Codes. Wenn kein Code ausgewählt ist, wird die Syntax des gesamten MDX-Abfrage-Editorfensters geprüft.|  
