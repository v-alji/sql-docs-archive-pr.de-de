...
## <a name="see-also"></a>Weitere Informationen
 [Attribute der](multidimensional-models/parent-child-dimension-attributes.md) über [-und untergeordneten Hierarchie](multidimensional-models/parent-child-dimension.md) in über-/Unterordnung
