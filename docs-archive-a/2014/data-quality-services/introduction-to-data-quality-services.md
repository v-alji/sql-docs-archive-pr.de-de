...
##  <a name="answering-the-need-with-dqs"></a><a name="Answer"></a>Beantworten der Anforderung mit DQS
...
-   **Reference Data Services:** Überprüfen der Datenqualität unter Verwendung des Diensts eines Verweisdatenanbieters. Mithilfe von Verweis Datendiensten von Azure Marketplace datamarket können Sie Daten problemlos bereinigen, überprüfen, abgleichen und erweitern. Weitere Informationen finden Sie unter [Reference Data Services in DQS](../../2014/data-quality-services/reference-data-services-in-dqs.md).
...
-   **Wissensdatenbank:** Data Quality Services ist eine wissensorientierte Lösung, die Daten anhand von Informationen analysiert, die Sie mit DQS erstellt haben. Dies ermöglicht es Ihnen, Data Quality-Prozesse zu erstellen, wodurch die Informationen über Ihre Daten kontinuierlich erweitert werden und somit die Qualität Ihrer Daten verbessert wird.
 ...
 ![DQS-Prozess](../../2014/data-quality-services/media/dqs-process.gif "DQS-Prozess")
