...
##  <a name="enable-the-speller"></a><a name="Enable"></a> Aktivieren der Rechtschreibprüfung  
...
##  <a name="use-the-speller"></a><a name="Use"></a> Verwenden der Rechtschreibprüfung  
...
##  <a name="follow-up-after-using-the-speller"></a><a name="FollowUp"></a> Nachverfolgung: Nach dem Verwenden der Rechtschreibprüfung  
...
##  <a name="how-the-speller-works"></a><a name="How"></a> Funktionsweise der Rechtschreibprüfung  
