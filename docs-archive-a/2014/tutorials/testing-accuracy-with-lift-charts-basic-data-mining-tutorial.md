...
6.  Verwenden Sie die Legende, um die farbigen Zeilen zu identifizieren, die das Idealmodell und das Zufallsvorhersagemodell darstellen.  
     ...
     Sie werden feststellen, dass das `TM_Decision_Tree` Modell den größten Lift bietet und dabei sowohl die Clustering-als auch Naive Bayes-Modelle bietet.  
