...
##  <a name="model-tab"></a><a name="bkmk_Model"></a>Registerkarte Modell  
 Auf der Registerkarte **Modell** des [!INCLUDE[msCoName](../includes/msconame-md.md)] Time Series-Viewers im Data Mining-Designer können Sie das Vorhersagemodell in Form eines Struktur Diagramms anzeigen.  
