...
> [!TIP]  
>  Dieser Abschnitt wird fortlaufend mit weiteren Lektionen und Informationen ergänzt. Das Zurückkehren zu dieser Seite lohnt sich.  
  
## <a name="supplemental-lessons"></a>Ergänzende Lektionen  
  
|Lektion|Für den Abschluss benötigte Zeit|  
|------------|----------------------|  
|[Implementieren von dynamischer Sicherheit mithilfe von Zeilenfiltern](../../2014/tutorials/implement-dynamic-security-by-using-row-filters.md)|30|  
