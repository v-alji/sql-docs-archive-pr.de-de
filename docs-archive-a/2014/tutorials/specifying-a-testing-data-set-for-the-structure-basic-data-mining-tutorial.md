...
1.  Überprüfen Sie auf der Seite **Testsatz erstellen** für den **Prozentsatz der zu testenden Daten**den Standardwert `30` .  
  
2.  Geben Sie für **Maximale Anzahl von Fällen in Test**Dataset ein `1000` .  
...
1.  Geben Sie auf der Seite **Assistenten abschließen** unter **Mining Struktur Name den Namen**ein `Targeted Mailing` .  
  
2.  Geben Sie in **Mining Modellname den Namen**ein `TM_Decision_Tree` .  
