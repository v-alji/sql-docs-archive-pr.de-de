...
# <a name="creating-a-targeted-mailing-mining-model-structure-basic-data-mining-tutorial"></a>Erstellen der Miningmodellstruktur "Targeted Mailing" (Basic Data Mining-Lernprogramm)
 ...
 In dieser Aufgabe richten Sie eine neue Mining Struktur ein und fügen basierend auf dem Decision Trees-Algorithmus ein ursprüngliches Mining Modell hinzu [!INCLUDE[msCoName](../includes/msconame-md.md)] . Um die Struktur zu erstellen, wählen Sie zuerst Tabellen und Sichten aus. Anschließend legen Sie fest, welche Spalten für das Trainieren und welche für das Testen verwendet werden.  
