...
```  
 ...
 Sie können die diskretisieren-Funktion in verwenden \<mining structure columns> , um kontinuierliche Spalten mithilfe der folgenden Syntax diskretisieren:  
...
3.  Klicken Sie in **Objekt-Explorer**mit der rechten Maustaste auf die Instanz von [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] , zeigen Sie auf **neue Abfrage**, und klicken Sie dann auf **DMX** , um den **Abfrage-Editor** und eine neue, leere Abfrage zu öffnen.  
