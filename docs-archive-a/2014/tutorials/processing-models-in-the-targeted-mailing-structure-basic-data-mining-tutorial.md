...
-   Bei der *Verarbeitung* werden- [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Objekte mit Daten aus relationalen Datenquellen aufgefüllt.  
...
1.  Klicken Sie im Data Mining-Designer von auf die Registerkarte **Mining Struktur** oder auf die Registerkarte **Mining Modelle** [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] .  
