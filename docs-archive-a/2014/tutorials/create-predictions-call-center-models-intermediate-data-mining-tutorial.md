...
8.  Klicken Sie auf die Zeile für LVL 2-Operatoren, und geben Sie ein `6` .  
...
2.  Wählen Sie im Datenquellen Sicht-Assistenten [!INCLUDE[ssAWDWsp](../includes/ssawdwsp-md.md)] als Datenquelle aus, und klicken Sie dann auf **weiter**.  
...
6.  Geben Sie im Dialogfeld **benannte Abfrage erstellen** im Feld **Name den Namen**ein `Shifts for Call Center` .  
