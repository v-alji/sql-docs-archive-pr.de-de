...
1.  Bewegen Sie den Mauszeiger im Bereich **Variablen** über die farbige Leiste in der ersten Zeile.  
     ...
     Diese farbige Leiste zeigt, wie stark zur `Average Time Per Issue` Dienst Qualität beiträgt. Die QuickInfo zeigt das Gesamtergebnis, die Wahrscheinlichkeiten und die Liftergebnisse für jede Kombination einer Variablen mit einem Zielergebnis an.  
...
1.  Wählen Sie im Data Mining-Designer auf der Registerkarte **Mining Modell-Viewer** aus \<mining model name> .  
