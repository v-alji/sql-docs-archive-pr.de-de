...
-   Der Satz von Ergebnisausdruckswerten wird zurückgegeben.  
 ...
 Verwenden Sie die [Lookup-Funktion (Berichts-Generator und SSRS)](report-builder-functions-lookup-function.md), um einen einzelnen Wert aus einem Dataset mit Name-Wert-Paaren für einen angegebenen Namen abzurufen, wenn eine 1:1-Beziehung besteht. Um `Lookup` einen Satz von Werten aufzurufen, verwenden Sie die [Multilookup-Funktion &#40;Berichts-Generator und SSRS&#41;](report-builder-functions-multilookup-function.md).  
...
## <a name="example"></a>Beispiel  
 ...
 Der folgende Ausdruck verwendet, wenn er als Value-Eigenschaft für ein Textfeld verwendet wird, `Join` um eine Liste zu erstellen.  
