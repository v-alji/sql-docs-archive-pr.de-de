...
##  <a name="restrictions-on-built-in-fields-collections-and-aggregate-functions"></a><a name="Restrictions"></a>Einschränkungen für integrierte Felder, Auflistungen und Aggregatfunktionen  
...
|Kontext|RunningValue|RowNumber|First<br /><br /> Letzter|Vorherige|Sum und andere Vorsortierungsfunktionen|ReportItem-Aggregate|Suchfunktionen|Aggregatfunktion|  
|-------------|------------------|---------------|--------------------|--------------|-------------------------------------|---------------------------|----------------------|------------------------|  
|Ausgeführter Wert|Nein|Nein|Nein|Nein|Ja|Nein|Ja|Nein|  
|First<br /><br /> Letzter|Nein|Nein|Nein|Nein|Ja|Nein|Nein|Nein|  
|Vorherige|Ja|Ja|Ja|Nein|Ja|Nein|Ja|Nein|  
...
##  <a name="calculating-running-values"></a><a name="CalculatingRunningValues"></a>Berechnen von laufenden Werten  
...
##  <a name="retrieving-row-counts"></a><a name="RetrievingRowCounts"></a>Abrufen von Zeilen Anzahlen  
...
##  <a name="retrieving-sort-dependent-values"></a><a name="RetrievingPostsortValues"></a>Abrufen von Sortierungs abhängigen Werten  
...
|**Function**|**Beschreibung**|  
|------------------|---------------------|  
|[First](report-builder-functions-first-function.md)|Gibt den ersten Wert im festgelegten Bereich des angegebenen Ausdrucks zurück.|  
|[Letzten](report-builder-functions-last-function.md)|Gibt den letzten Wert im festgelegten Bereich des angegebenen Ausdrucks zurück.|  
|[Zurück](report-builder-functions-previous-function.md)|Gibt den Wert oder den angegebenen Aggregatwert für die vorherige Instanz eines Elements innerhalb des angegebenen Bereichs zurück.|  
  
##  <a name="retrieving-server-aggregates"></a><a name="RetrievingServerAggregates"></a>Abrufen von Server Aggregaten  
...
##  <a name="testing-for-scope"></a><a name="TestingforScope"></a>Testen für den Bereich  
...
##  <a name="retrieving-recursive-level"></a><a name="RetrievingRecursiveLevel"></a>Abrufen der rekursiven Ebene  
