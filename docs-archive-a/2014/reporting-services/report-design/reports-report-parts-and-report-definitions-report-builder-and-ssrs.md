...
# <a name="reports-report-parts-and-report-definitions-report-builder-and-ssrs"></a>Berichte, Berichtsteile und Berichtsdefinitionen (Berichts-Generator und SSRS)
  [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]verwendet eine Vielzahl von Begriffen, um einen Bericht in verschiedenen Zuständen zu beschreiben, einschließlich der Anfangs Definition, des veröffentlichten Berichts und des angezeigten Berichts, wie er dem Benutzer angezeigt wird.  
