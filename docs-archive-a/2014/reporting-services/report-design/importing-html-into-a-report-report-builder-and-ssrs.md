...
-   Wenn ein Tag sowohl Attribute als auch CSS-Formatattribute enthält, kommt der CSS-Eigenschaft eine höhere Priorität zu. Wenn Ihr Text beispielsweise ist **\<p style="text-align: right" align="left">** , wird nur das Text-align-Attribut angewendet, und der Text wird rechtsbündig ausgerichtet.  
  
-   Wenn eine Eigenschaft bei Attributen oder CSS-Formaten mehrfach angegeben wurde, wird nur die letzte Instanz der Eigenschaft verwendet. Wenn Ihr Text beispielsweise ist **\<p align="left" align="right">** , wird der Text rechtsbündig ausgerichtet.  
