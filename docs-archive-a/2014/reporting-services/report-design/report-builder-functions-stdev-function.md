...
---
# <a name="stdev-function-report-builder-and-ssrs"></a>StDev-Funktion (Berichts-Generator und SSRS)
...
## <a name="example"></a>Beispiel  
 Das folgende Codebeispiel stellt die Standardabweichung der Einzelpostensummen in der Gruppierung bzw. dem Datenbereich `Order` bereit.  
