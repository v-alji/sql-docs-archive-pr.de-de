...
### <a name="customize-an-embedded-report-viewer-in-a-web-page"></a>Anpassen eines auf einer Webseite eingebetteten Berichts-Viewers  
 ...
 Wenn Sie das Berichts-Viewer-Webpart in eine Webseite einbetten, sollten Sie die **Berichts-URL** -Eigenschaft auf einen bestimmten Bericht festlegen. Andernfalls werden im Berichts-Viewer Anweisungen zum Verknüpfen mit einem Bericht angezeigt. Die Anweisungen können Sie nicht anpassen oder entfernen.  
...
|Symbolleistenspeicherort|Bestimmt die Position der Symbolleiste innerhalb des Berichts-Viewers. Beispielsweise können die folgenden Werte verwendet werden: `Top` und `Bottom`.|  
