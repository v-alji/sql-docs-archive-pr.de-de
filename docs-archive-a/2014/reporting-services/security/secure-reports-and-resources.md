...
3.  Ein Angreifer erstellt einen Link zur Webseite oder zum Berichts Server, der den Wert des Parameters in der Form "JavaScript: \<malicious script here> " angibt, und sendet diesen Link an eine andere Person in einem Lock Angriff.  
