...
3.  Verwenden Sie den Berichts-Manager, wenn Sie bereit sind, Benutzer- und Gruppenkonten bestimmten Rollen zuzuweisen. Weitere Informationen finden Sie unter [Gewähren von Benutzer Zugriff auf einen Berichts Server &#40;Berichts-Manager&#41;](grant-user-access-to-a-report-server.md).  
  
##  <a name="predefined-role-definitions"></a><a name="bkmk_rolelist"></a>Vordefinierte Rollen Definitionen  
...
##  <a name="content-manager-role"></a><a name="bkmk_content"></a>Inhalts-Manager-Rolle  
...
### <a name="content-manager-tasks"></a>Aufgaben des Inhalts-Managers  
 In der folgenden Tabelle sind die Aufgaben aufgeführt, die in der **Inhalts-Manager** -Rolle enthalten sind.  
...
|Verwalten von Datenquellen|Freigegebene Datenquellenelemente erstellen und löschen, Datenquelleneigenschaften und Inhalt anzeigen und ändern.|  
...
##  <a name="publisher-role"></a><a name="bkmk_publisher"></a>Verleger-Rolle  
...
### <a name="publisher-tasks"></a>Verlegeraufgaben  
 In der folgenden Tabelle sind die Aufgaben aufgeführt, die in der **Verleger** -Rolle enthalten sind.  
...
##  <a name="browser-role"></a><a name="bkmk_browser"></a>Browser Rolle  
...
##  <a name="report-builder-role"></a><a name="bkmk_reportbuilder"></a>Berichts-Generator Rolle  
...
##  <a name="my-reports-role"></a><a name="bkmk_myreports"></a>Meine Berichte Rolle  
...
### <a name="my-reports-tasks"></a>Aufgaben in Meine Berichte  
 In der folgenden Tabelle sind die Aufgaben aufgeführt, die in der **Meine Berichte** -Rolle enthalten sind.  
...
##  <a name="system-administrator-role"></a><a name="bkmk_systemadministrator"></a>System Administrator Rolle  
...
### <a name="system-administrator-tasks"></a>Systemadministratoraufgaben  
 In der folgenden Tabelle sind die Aufgaben aufgeführt, die in der **System Administrator** -Rolle enthalten sind.  
...
##  <a name="system-user-role"></a><a name="bkmk_systemuser"></a>System Benutzerrolle  
