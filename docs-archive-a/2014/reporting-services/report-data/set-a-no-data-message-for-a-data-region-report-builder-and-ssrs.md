...
2.  Geben Sie im Eigenschaften Bereich den Text ein, der als Meldung im Eigenschaften Feld angezeigt werden soll `NoRowsMessage` .  
...
3.  Geben Sie in **Beschriftung**den Text ein, der als Meldung im Eigenschaften Feld angezeigt werden soll `NoDataMessage` .  
