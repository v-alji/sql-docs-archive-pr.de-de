...
2.  Öffnen Sie rssrvpolicy.config. Sie können die Konfigurationsdatei mit [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] oder einem einfachen Text-Editor wie Notepad öffnen.  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Implementieren einer Datenverarbeitungs Erweiterung](../extensions/data-processing/implementing-a-data-processing-extension.md)   
