 ...
 **Benutzerdefinierter Code**  
 Geben Sie die Methoden ein, die im Bericht verwendet werden sollen. Der Code muss in geschrieben werden [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] .  
