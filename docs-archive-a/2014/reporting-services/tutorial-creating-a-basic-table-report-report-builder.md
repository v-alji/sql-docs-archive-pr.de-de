...
3.  [Formatieren von Daten als Datum](#FormatDate)  
...
##  <a name="1-create-a-new-report-from-getting-started"></a><a name="CreateTable"></a>1. Erstellen eines neuen Berichts aus "Getting Started"  
...
5.  Geben Sie unter **Verbindungs Zeichenfolge**den folgenden Text *\<servername>* ein, wobei der Name einer Instanz von ist [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] :  
  
    ```  
    Data Source=<servername>  
    ```  
  
     Da Sie eine Abfrage verwenden, die die Daten enthält, anstatt die Daten aus einer Datenbank abzurufen, enthält die Verbindungszeichenfolge den Datenbanknamen nicht. Weitere Informationen finden Sie unter [Voraussetzungen für Lernprogramme &#40;Berichts-Generator&#41;](../reporting-services/report-builder-tutorials.md).  
  
6.  Klicken Sie auf **Anmeldeinformationen**. Geben Sie die für den Zugriff auf die externe Datenquelle benötigten Anmeldeinformationen ein.  
...
##  <a name="1e-choose-a-style-in-the-table-wizard"></a><a name="Style"></a>1E. Auswählen eines Formats im Tabellen-Assistenten  
...
##  <a name="5-add-a-report-title"></a><a name="Title"></a>5. Hinzufügen eines Berichts Titels  
...
1.  Öffnen Sie den Ordner **Dokumente** , und doppelklicken Sie auf **Product Sales #b0 **.  
