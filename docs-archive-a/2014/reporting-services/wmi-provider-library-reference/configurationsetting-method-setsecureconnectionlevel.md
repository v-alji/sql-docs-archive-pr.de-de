...
---
# <a name="setsecureconnectionlevel-method-wmi-msreportserver_configurationsetting"></a>SetSecureConnectionLevel-Methode (WMI: MSReportServer_ConfigurationSetting)
...
-   Wenn der Wert festgelegt ist, wird das SecureConnectionLevel-Element in der Berichts Server-Konfigurationsdatei geändert, und das- `URLRoot` Element in der Konfigurationsdatei wird so festgelegt, dass "https://" verwendet wird, wenn die angegebene *Ebene* größer oder gleich 1 ist, oder "http://", wenn die angegebene *Ebene* gleich 0 (null) ist.  
