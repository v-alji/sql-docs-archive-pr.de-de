...
---
# <a name="connectionpoolsize-property-wmi-msreportserver_configurationsetting"></a>ConnectionPoolSize-Eigenschaft (WMI: MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>Eigenschaftswerte  
 Ein Schreib geschütztes **ganzzahliges** Objekt, das den Wert zurückgibt `768` .  
