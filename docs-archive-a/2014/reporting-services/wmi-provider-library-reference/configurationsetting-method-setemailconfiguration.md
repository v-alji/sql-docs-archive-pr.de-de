...
## <a name="remarks"></a>Bemerkungen  
 Wenn der *SendUsingSMTPServer* -Parameter auf festgelegt ist `true` , wird der **SendUsing** -Eintrag in der Berichts Server-Konfigurationsdatei auf 1 festgelegt. Wenn *SendUsingSMTPServer* auf festgelegt ist `false` , wird der **SendUsing** -Eintrag nicht konfiguriert.  
