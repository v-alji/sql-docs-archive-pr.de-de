...
---
# <a name="databaselogontimeout-property-wmi-msreportserver_configurationsetting"></a>DatabaseLogonTimeout-Eigenschaft (WMI: MSReportServer_ConfigurationSetting)
