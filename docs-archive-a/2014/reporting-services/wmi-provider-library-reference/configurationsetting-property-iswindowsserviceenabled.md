...
---
# <a name="iswindowsserviceenabled-property-wmi-msreportserver_configurationsetting"></a>IsWindowsServiceEnabled-Eigenschaft (WMI: MSReportServer_ConfigurationSetting)
