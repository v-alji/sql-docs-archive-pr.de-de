...
4.  Fügen Sie einen Eintrag für die Übermittlungserweiterung hinzu. Der Eintrag sollte ein `Extension` Element mit Werten für `Name` und enthalten `Type` und könnte wie folgt aussehen:  
