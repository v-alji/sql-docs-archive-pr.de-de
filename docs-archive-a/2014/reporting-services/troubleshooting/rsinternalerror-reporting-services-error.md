...
## <a name="user-action"></a>Benutzeraktion  
 Überprüfen Sie die Berichts Server-Protokolldateien, die sich unter \Microsoft SQL server\msrs12. \<instancename > befinden, um die spezifische Ursache für diese Nachricht zu ermitteln. \Reporting Services\LogFiles. Weitere Informationen finden Sie unter [Reporting Services-Protokolldateien und Quellen](../report-server/reporting-services-log-files-and-sources.md).  
