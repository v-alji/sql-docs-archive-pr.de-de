...
|[107](../../relational-databases/errors-events/mssqlserver-107-database-engine-error.md)|Fehler|Start/Herunterfahren|Berichtsserver<br /><br /> Prozessor für Zeitplanung und Übermittlung|*\<Source>* mit der Berichts Server-Datenbank kann keine Verbindung hergestellt werden. Weitere Informationen finden Sie unter [Report Server-Windows-Dienst &#40;MSSQLServer&#41; 107](../../relational-databases/errors-events/mssqlserver-107-database-engine-error.md).|  
|108|Fehler|Durchwahl|Berichtsserver<br /><br /> Berichts-Manager|*\<Source>* eine Übermittlungs-, Datenverarbeitungs-oder Renderingerweiterung kann nicht geladen werden.<br /><br /> Dies ist wahrscheinlich auf eine unvollständige Bereitstellung oder das Entfernen einer Erweiterung zurückzuführen. Weitere Informationen finden Sie unter [Deploying a Data Processing Extension](../extensions/data-processing/deploying-a-data-processing-extension.md) und [Deploying a Delivery Extension](../extensions/delivery-extension/deploying-a-delivery-extension.md).|  
...
|111|Fehler|Protokollierung|Berichtsserver<br /><br /> Berichts-Manager|*\<Source>* Das Ablauf Verfolgungs Protokoll kann nicht erstellt werden. Weitere Informationen finden Sie unter [Report Server Service Trace Log](../report-server/report-server-service-trace-log.md).|  
...
|119|Fehler|Aktivierung|Berichtsserver<br /><br /> Prozessor für Zeitplanung und Übermittlung|*\<Source>* wurde kein Zugriff auf den Inhalt der Berichts Server-Datenbank gewährt.|  
...
|130|Fehler|Verwaltung|Berichtsserver<br /><br /> Prozessor für Zeitplanung und Übermittlung|*\<Source>* die Konfigurationsdatei wurde nicht gefunden. Konfigurationsdateien sind für den Berichtsserver erforderlich.|  
