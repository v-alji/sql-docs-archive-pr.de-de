...
2.  Klicken Sie in der Spalte **salesdate** auf die Zelle in der zweiten Zeile (unter der Zeile Spaltenüberschriften), und wählen Sie alle Zellen aus, die enthalten `[Sum(Sales)]` .  
