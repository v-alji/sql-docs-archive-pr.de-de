...
## <a name="file-location"></a>Dateispeicherort  
 Rskeymgmt.exe befindet sich unter ** \<*drive*> : \Programme\Microsoft SQL server\110\tools\binn** oder unter ** \<*drive*> : \Program Files (x86) \Microsoft SQL server\110\tools\binn**. Sie können das Hilfsprogramm von einem beliebigen Ordner im Dateisystem ausführen.  
