...
# <a name="server-properties-logging-page"></a>Servereigenschaften (Seite Protokollierung)
 ...
 Um diese Seite zu öffnen, starten [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] Sie, stellen eine Verbindung mit einem Berichts Server her, klicken mit der rechten Maustaste auf den Namen des Berichts Servers und wählen **Eigenschaften**aus. Klicken Sie auf **Protokollierung** , um diese Seite zu öffnen.  
