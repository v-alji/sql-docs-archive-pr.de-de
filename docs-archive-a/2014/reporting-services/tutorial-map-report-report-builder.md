...
17. Wählen Sie unter **Datenfeld**aus, `[Sum(SellingArea)]` um die Markertypen nach der Größe des Bereichs zu verändern, den ein Speicher für die Anzeige der Produkte reserviert.  
