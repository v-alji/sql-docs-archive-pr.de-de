...
## <a name="support-for-bing-maps"></a>Unterstützung von Bing-Karten  
 ...
 Berichtsautoren können in jedem Bericht angeben, ob eine Secure Sockets Layer (SSL)-Verbindung verwendet werden soll, um Kacheln vom Kachelserver abzurufen. Zu diesem Zweck müssen Sie im Bereich "Eigenschaften" für die Kachel Ebene die boolesche Eigenschaft "seresecureconnection" auf festlegen `true` .  
