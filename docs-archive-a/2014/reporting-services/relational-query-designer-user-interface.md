...
#### <a name="group-and-aggregate"></a>Gruppieren und aggregieren:  
 ...
 [!INCLUDE[ssDWfull](../includes/ssdwfull-md.md)] nutzt [!INCLUDE[tsql](../includes/tsql-md.md)], und [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssDWfull](../includes/ssdwfull-md.md)] nutzt [!INCLUDE[DWsql](../includes/dwsql-md.md)]. Beide Dialekte der SQL-Sprache unterstützen die Klausel, das Schlüsselwort und die Aggregate, die der Abfrage-Designer bereitstellt.  
