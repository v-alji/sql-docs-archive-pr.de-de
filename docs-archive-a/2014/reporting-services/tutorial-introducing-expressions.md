...
13. Klicken Sie in der Liste **Werte** mit der rechten Maustaste, `CountryRegionID` und klicken Sie auf die Option **Sum** .  
...
##  <a name="6-count-days-since-last-purchase"></a><a name="Count"></a>6. Anzahl der Tage seit dem letzten Kauf  
 Fügen Sie eine Spalte hinzu, und verwenden Sie anschließend die **Now** -Funktion oder die `ExecutionTime` integrierte globale Variable, um die Anzahl der Tage seit dem letzten Einkauf einer Person zu berechnen.  
