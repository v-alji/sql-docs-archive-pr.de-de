...
-   Auflisten von Abonnements: (Hyperlink "", lesen Sie den https://technet.microsoft.com/library/microsoft.reportingservices.interfaces.reportoperation.aspx Bericht, und der Benutzer ist der Abonnement Besitzer) oder "Read anyabonnement"
...
-   Auflisten von Abonnements: managealerts oder (Hyperlink " https://technet.microsoft.com/library/microsoft.sharepoint.spbasepermissions.aspx " für den Bericht, und der Benutzer ist der Abonnement Besitzer und das Abonnement ist ein Zeit gesteuerter Abonnement).
