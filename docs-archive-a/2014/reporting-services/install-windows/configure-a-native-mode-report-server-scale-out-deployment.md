...
-   Anweisungen zum Installieren von Berichts Server Instanzen finden Sie unter [Install SQL Server 2014 from the Installation Wizard &#40;Setup&#41;in der](../../database-engine/install-windows/install-sql-server-from-the-installation-wizard-setup.md) [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Online Dokumentation.
