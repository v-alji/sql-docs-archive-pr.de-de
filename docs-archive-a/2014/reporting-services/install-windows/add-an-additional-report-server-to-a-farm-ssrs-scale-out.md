...
##  <a name="additional-configuration"></a><a name="bkmk_additional"></a>Zusätzliche Konfiguration  
 ...
 Legen Sie **\<IsWebServiceEnable>** in der **RSreportServer.config** Konfigurationsdatei auf false fest, um das Verhalten einzelner Berichts Server zu ändern.  
  
 Standardmäßig werden Berichts Server konfiguriert \<IsWebServiceEnable> , wobei auf true festgelegt ist. Wenn alle Server auf TRUE festgelegt werden, besteht bei der interaktiven und Hintergrundverarbeitung ein Lastenausgleich über alle Knoten hinweg in der Farm.  
  
 Wenn Sie alle Berichts Server konfigurieren \<IsWebServiceEnable> , bei denen auf false festgelegt ist, wird eine Fehlermeldung ähnlich der folgenden angezeigt, wenn Sie versuchen, Features zu verwenden [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] :  
  
 Der Reporting Services-Webdienst ist nicht aktiviert. Konfigurieren Sie mindestens eine Instanz des Reporting Services SharePoint-Dienstanbieter auf \<IsWebServiceEnable> true festgelegt ist. Weitere Informationen finden Sie unter [Ändern einer Reporting Services-Konfigurationsdatei &#40;RSreportserver.config&#41;](../report-server/modify-a-reporting-services-configuration-file-rsreportserver-config.md).  
