...
4.  Klicken Sie **Expression** im `ProductID` abgelegten Ausdruck auf aus der Dropdown Liste. Dies ist die Spalte, auf die Sie den Filter anwenden.  
  
5.  Klicken Sie **=** in der Dropdown Liste **Operator** auf den Gleichheits Operator ().  
  
6.  Klicken Sie neben dem Feld **Wert** auf die Ausdrucks Schaltfläche, klicken Sie im Bereich **Kategorie** auf **Parameter** , und doppelklicken Sie dann `productid` auf den Bereich **Werte** . Das Feld **Ausdruck festlegen für: Wert** sollte jetzt einen mit **=Parameters!productid.Value**vergleichbaren Ausdruck enthalten.  
...
5.  Vervollständigen Sie den Ereignishandler. Er sollte folgende Funktionen umfassen.  
    ...
    3.  Binden Sie die Datentabelle `PurchaseOrderDetail` an die entsprechende Datenquelle des Berichts.  
