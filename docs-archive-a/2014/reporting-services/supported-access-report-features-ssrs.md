...
|Filter|FilterAktiv|Format|FormatBedingungen|  
...
|DatTeil|DatSeriell|DatWert|Tag|  
|Hour|Minute|Month (Monat)|MonthName|  
|jetzt|Sekunde|Time|Time$|  
...
|StrKonv|String|String$|StrReverse|  
