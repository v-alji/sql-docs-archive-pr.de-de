...
##  <a name="overview-of-report-server-modes"></a><a name="bkmk_overview"></a>Übersicht über Berichts Server Modi
...
##  <a name="feature-comparison-of-sharepoint-and-native-mode"></a><a name="bkmk_featuresupport"></a>Funktions Vergleich zwischen SharePoint und einheitlichem Modus
...
|**Konfigurations-Manager**|Ja|Wichtig Configuration Manager kann nicht zum Verwalten eines Berichts Servers im SharePoint-Modus verwendet werden. ** \* \* \* \* ** Verwenden Sie stattdessen die SharePoint-Zentraladministration.|
...
##  <a name="native-mode"></a><a name="bkmk_nativemode"></a>Einheitlicher Modus
...
###  <a name="native-mode-with-sharepoint-web-parts"></a><a name="bkmk_nativewithwebparts"></a>Einheitlicher Modus mit SharePoint-Webparts
...
##  <a name="sharepoint-mode"></a><a name="bkmk_sharepointmode"></a>SharePoint-Modus
...
##  <a name="report-process-and-schedule-and-delivery-process"></a><a name="bkmk_reportprocessor"></a>Berichtsprozess und Zeitplan und Übermittlungs Prozess
...
##  <a name="report-server-database"></a><a name="bkmk_reportdatabase"></a>Berichts Server-Datenbank
...
##  <a name="authentication-rendering-data-and-delivery-extensions"></a><a name="bkmk_authentication"></a>Authentifizierungs-, Rendering-, Daten-und Übermittlungs Erweiterungen
