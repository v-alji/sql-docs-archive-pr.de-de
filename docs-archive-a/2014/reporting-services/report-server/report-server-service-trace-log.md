...
> [!NOTE]
>  In vorherigen Versionen waren mehrere Ablaufverfolgungsprotokolldateien vorhanden, eine pro Anwendung. Die folgenden Dateien sind veraltet und werden in und höheren Versionen nicht mehr erstellt [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] : ReportServerWebApp_ *\<timestamp>* . log, ReportServer_ *\<timestamp>* . log und ReportServerService_main_ *\<timestamp>* . log.
...
##  <a name="log-file-fields"></a><a name="bkmk_log_file_fields"></a>Protokolldatei Felder
