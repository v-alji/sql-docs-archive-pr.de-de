...
1.  Zeigen Sie im Menü Start auf **Verwaltung**, und klicken Sie auf **Komponentendienste**.  
     ...
     Für Windows Vista klicken Sie im Startmenü auf **Alle Programme**, klicken Sie auf **Ausführen**, und geben Sie dann ein `mmc comexp.msc` .  
...
10. Wählen Sie unter **Berechtigungen für \<User or Group> **in der Spalte **zulassen** die Option **Remote Start** und **Remote Aktivierung**aus, und klicken Sie dann auf **OK**.  
