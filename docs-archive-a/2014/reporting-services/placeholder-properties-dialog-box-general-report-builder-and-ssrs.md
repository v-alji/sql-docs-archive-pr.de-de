 ...
 **Wert**  
 Geben Sie den Wert des Textfelds ein. Hierbei kann es sich um einen Feldausdruck, einen sonstigen Ausdruck oder eine Bezeichnung handeln. Klicken Sie auf die **Ausdrucks** Schaltfläche (*FX*), um den Ausdruck zu bearbeiten.  
  
 **QuickInfo**  
 Geben Sie Text oder einen Ausdruck ein, der zu einer QuickInfo ausgewertet wird. Klicken Sie auf die **Ausdrucks** Schaltfläche (*FX*), um den Ausdruck zu bearbeiten. Die QuickInfo wird angezeigt, wenn der Benutzer den Zeiger über das Element im gerenderten Bericht hält.  
