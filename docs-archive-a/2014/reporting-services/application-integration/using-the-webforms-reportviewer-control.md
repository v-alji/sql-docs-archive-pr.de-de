...
1.  Erstellen Sie eine neue [!INCLUDE[msCoName](../../includes/msconame-md.md)] ASP.NET-Website mit [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[csprcs](../../includes/csprcs-md.md)] oder [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .  
...
3.  Suchen Sie in der ** Toolbox** das **ReportViewer**-Steuerelement, und ziehen Sie es auf der Entwurfsoberfläche unter das **ScriptManager**-Steuerelement.  
 ...
 Beim Rendern des Berichts können Sie eines oder mehrere Elemente auf der ReportViewer-Symbolleiste ausblenden. Beispielsweise können Sie die Druckschaltfläche ausblenden. Um Symbolleisten Elemente auszublenden, legen Sie die folgenden Report Viewer-Eigenschaften `False` im Bereich **Eigenschaften** auf fest.  
