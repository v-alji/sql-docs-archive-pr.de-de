...
# <a name="managing-services-how-to-topics-sql-server-configuration-manager"></a>Verwalten von Diensten: Themen zur Vorgehensweise (SQL Server-Konfigurations-Manager)
  Die [!INCLUDE[ssDE](../includes/ssde-md.md)] - und [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] -Agents werden auf den [!INCLUDE[msCoName](../includes/msconame-md.md)] Windows-Betriebssystemen als Dienste ausgeführt. Weitere Informationen zu Diensten finden Sie unter [Manage the Database Engine Services](configure-windows/manage-the-database-engine-services.md).  
