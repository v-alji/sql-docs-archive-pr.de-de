...
6.  Gehen Sie wie folgt vor, um die Optionen für den **Speicherpartitionsmodus** anzugeben:  
    ...
    1.  **None** (Keine). Aktivieren Sie diese Option, wenn Sie keinen Speicherpartitionsmodus benötigen.  
