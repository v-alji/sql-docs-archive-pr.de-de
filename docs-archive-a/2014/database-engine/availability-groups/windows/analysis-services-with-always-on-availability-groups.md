...
7.  Vergewissern Sie sich, dass das Failover erfolgreich ausgeführt wurde:  
    ...
    -   Zeigen Sie das Dashboard an, um zu bestimmen, ob Integritätsprobleme gefunden wurden. Klicken Sie mit der rechten Maustaste auf die Verfügbarkeits Gruppe und wählen Sie **Dashboard anzeigen**  
