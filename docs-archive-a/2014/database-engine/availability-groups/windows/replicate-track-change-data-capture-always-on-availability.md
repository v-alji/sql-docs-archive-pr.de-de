...
##  <a name="overview-of-replication-on-alwayson-availability-groups"></a><a name="Overview"></a>Übersicht über die Replikation auf AlwaysOn-Verfügbarkeitsgruppen  
...
###  <a name="publisher-redirection"></a><a name="PublisherRedirect"></a> Verlegerumleitung  
 ...
 In einer AlwaysOn-Verfügbarkeitsgruppe kann eine sekundäre Datenbank nicht als Verleger fungieren. Das erneute Veröffentlichen wird nicht unterstützt, wenn die Replikation mit [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)]kombiniert wird.  
...
###  <a name="general-changes-to-replication-agents-to-support-alwayson-availability-groups"></a><a name="Changes"></a>Allgemeine Änderungen an Replikations-Agents zur Unterstützung AlwaysOn-Verfügbarkeitsgruppen  
...
###  <a name="stored-procedures-supporting-alwayson"></a><a name="StoredProcs"></a>Gespeicherte Prozeduren unterstützen AlwaysOn  
...
|**Momentaufnahme**|Ja|Nein|Ja<sup>2</sup>|  
 ...
 <sup>1</sup> bietet keine Unterstützung für bidirektionale und wechselseitige Transaktions Replikation.  
  
 <sup>2</sup> das Failover auf die Replikat Datenbank ist eine manuelle Prozedur. Automatisches Failover wird nicht bereitgestellt.  
  
 <sup>3</sup> die Verteiler Datenbank wird für die Verwendung mit [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] oder der Daten Bank Spiegelung nicht unterstützt.  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [AlwaysOn-Verfügbarkeitsgruppen: Interoperabilität (SQL Server)](always-on-availability-groups-interoperability-sql-server.md) [AlwaysOn-Failoverclusterinstanzen (SQL Server)](../../../sql-server/failover-clusters/windows/always-on-failover-cluster-instances-sql-server.md)   
