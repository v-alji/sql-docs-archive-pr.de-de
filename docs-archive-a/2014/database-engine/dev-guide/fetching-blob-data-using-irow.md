...
-   [Abrufen von BLOB-Daten mithilfe von 'IRow::GetColumns' und 'ISequentialStream'](../../relational-databases/native-client-ole-db-rowsets/fetching-blob-data-using-irow-getcolumns-and-isequentialstream.md)  
