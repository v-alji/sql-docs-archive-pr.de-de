...
```  
 ...
 Dies ist das [!INCLUDE[tsql](../../includes/tsql-md.md)]-Installationsskript (`Install.sql`), das die Assembly bereitstellt und die Funktionen mit ergänzenden Funktionen in der Datenbank erstellt.  
