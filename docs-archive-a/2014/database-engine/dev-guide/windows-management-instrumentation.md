---
title: Windows-Verwaltungsinstrumentation | Microsoft-Dokumentation
ms.custom: ''
ms.date: 06/13/2017
...
-   [Ereignisse und Fehler für WMI-Anbieter](../../relational-databases/native-client-ole-db-errors/errors.md)  
  
-   [Klassen für WMI-Anbieter für die Konfigurationsverwaltung](../../relational-databases/wmi-provider-configuration-classes/wmi-provider-for-configuration-management-classes.md)  
