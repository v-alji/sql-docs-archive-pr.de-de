...
# <a name="interfaces-ole-db"></a>Schnittstellen (OLE DB)
  Zusätzlich zu den Kern OLE DB Schnittstellen, die von den Microsoft Data Access Components (MDAC) bereitgestellt werden, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] implementiert der Native Client OLE DB-Anbieter die folgenden zusätzlichen OLE DB Schnittstellen:  
