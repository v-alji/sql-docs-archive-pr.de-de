...
3.  **Sichere Endpunkte (HTTPS) verwenden** : bei dieser Option wird die verschlüsselte Kommunikation und die sichere Identifizierung eines netzwerkweb Servers verwendet.  
