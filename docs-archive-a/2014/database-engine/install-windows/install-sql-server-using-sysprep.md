...
## <a name="prerequisites"></a>Voraussetzungen  
 ...
 Weitere Informationen zu [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Editionen und den Hardware-und Softwareanforderungen finden Sie unter [Hardware-und Softwareanforderungen für die Installation von SQL Server 2014](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md).  
  
> [!IMPORTANT]  
>  Folgendes wird von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SysPrep nicht unterstützt:  
>   
>  WOW 64-Installationen: eine Funktion von 64-Bit-Editionen von Windows, die es ermöglicht, 32-Bit-Anwendungen im systemeigenen 32-Bit-Modus auszuführen.  
  
 Dieser Abschnitt enthält die folgenden Verfahrensweisen:  
  
-   [Clusterunterstützung von SQL Server SysPrep](#sysprep)  
  
-   [Vorbereiten einer eigenständigen Instanz von SQL Server](#prepare)  
  
-   [Abschließen einer vorbereiteten Instanz von SQL Server](#complete)  
  
-   [Hinzufügen von Funktionen zu einer vorbereiteten Instanz von SQL Server](#AddFeatures)  
...
1.  Bereiten Sie das Image (wie unter [Considerations for Installing SQL Server Using SysPrep](considerations-for-installing-sql-server-using-sysprep.md)(Überlegungen zum Installieren von SQL Server mit SysPrep) erläutert) vor, und zeichnen Sie das Windows-Image mithilfe der Generalisierung mit SysPrep. Im folgenden Beispiel wird das Image vorbereitet:  
...
18. Hiermit wird der Vorbereitungsschritt abgeschlossen. Sie können das Image abschließen oder das vorbereitete Image bereitstellen, wie unter [Considerations for Installing SQL Server Using SysPrep](considerations-for-installing-sql-server-using-sysprep.md)beschrieben.  
