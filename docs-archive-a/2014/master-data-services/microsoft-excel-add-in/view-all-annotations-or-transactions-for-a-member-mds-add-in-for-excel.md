...
### <a name="to-view-annotations-or-transactions"></a>So zeigen Sie Anmerkungen oder Transaktionen an  
  
1.  Klicken Sie in die Zeile, die Transaktionen enthält, die Sie anzeigen möchten.  
  
2.  Klicken Sie mit der rechten Maustaste, und klicken Sie im angezeigten Menü auf **Transaktionen anzeigen**.  
