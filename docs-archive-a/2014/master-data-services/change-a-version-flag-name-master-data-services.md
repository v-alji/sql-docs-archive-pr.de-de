...
### <a name="to-change-a-version-flag-name"></a>So ändern Sie den Namen eines Versionsflags  
...
3.  Wählen Sie auf der Seite **Versionsflags verwalten** im Feld **Modell** ein Modell aus.  
  
4.  Doppelklicken Sie im Raster in der Zeile für den Flagnamen auf das Feld **Name** .  
  
5.  Geben Sie einen neuen Namen für das Flag ein.  
