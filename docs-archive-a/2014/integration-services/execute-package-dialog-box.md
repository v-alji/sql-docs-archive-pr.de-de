...
##  <a name="open-the-execute-package-dialog-box"></a><a name="open_dialog"></a> Öffnen des Dialogfelds "Paket ausführen"  
...
##  <a name="scripting-the-options-in-the-execute-package-dialog-box"></a><a name="script"></a> Erstellen der Optionen im Dialogfeld Paket ausführen  
