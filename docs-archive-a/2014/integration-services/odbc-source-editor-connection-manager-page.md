...
### <a name="connection-manager"></a>Ziel-Editor für Dimensionsverarbeitung  
 Wählen Sie einen vorhandenen ODBC-Verbindungs-Manager aus der Liste aus, oder klicken Sie auf **neu** , um eine neue Verbindung zu erstellen. Sie können eine Verbindung mit jeder von ODBC unterstützten Datenbank erstellen.  
