...
## <a name="configuring-a-source-component-in-metadata-design-mode"></a>Konfigurieren einer Quellkomponente im Metadatenentwurfsmodus
 Nachdem Sie die Erstellung einer Quellkomponente ausgewählt haben, konfigurieren Sie die Komponente mit dem **Transformations-Editor für Skripterstellung**. Weitere Informationen finden Sie unter [Configuring the Script Component in the Script Component Editor (Konfigurieren der Skriptkomponente im Skriptkomponenten-Editor)](../extending-packages-scripting/data-flow-script-component/configuring-the-script-component-in-the-script-component-editor.md).
...
3.  Die private `MarkOutputsAsFinished`-Methode, welche die <xref:Microsoft.SqlServer.Dts.Pipeline.ScriptBuffer.SetEndOfRowset%2A>-Methode der übergeordneten <xref:Microsoft.SqlServer.Dts.Pipeline.ScriptBuffer>-Klasse aufruft, um die Datenfluss-Engine über die Fertigstellung der Ausgabe in Kenntnis zu setzen. Sie müssen `SetEndOfRowset` nicht explizit in Ihrem eigenen Code aufrufen.
