...
## <a name="expression-examples"></a>Beispiele für Ausdrücke  
 In diesem Beispiel wird nur zu TRUE ausgewertet, falls das aktuelle Datum nicht der 4. Juli 2003 ist. Weitere Informationen finden Sie unter [GETDATE &#40;SSIS-Ausdruck&#41;](getdate-ssis-expression.md).  
