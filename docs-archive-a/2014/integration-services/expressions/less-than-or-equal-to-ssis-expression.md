...
---
# <a name="lt-less-than-or-equal-to-ssis-expression"></a>&lt;= (Kleiner als oder gleich) (SSIS-Ausdruck)
...
```  
 ...
 In diesem Beispiel wird die **LPrice** -Variable ausgewertet, und es wird zu TRUE ausgewertet, falls der Wert kleiner oder gleich 500 ist. Der Datentyp von **LPrice** muss numerisch sein, damit der Ausdruck analysiert wird.  
