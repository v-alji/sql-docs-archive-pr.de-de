...
7.  Beachten Sie beim Erstellen, Bereitstellen und Debuggen Ihres neuen benutzerdefinierten Objekts die Beschreibungen in [Erstellen, Bereitstellen und Debuggen von benutzerdefinierten Objekten](building-deploying-and-debugging-custom-objects.md).
...
|-------------------|----------------|---------------|-----------------------|
|Aufgabe|[Microsoft. SqlServer. DTS. Runtime. Task](/dotnet/api/microsoft.sqlserver.dts.runtime.task)|<xref:Microsoft.SqlServer.Dts.Runtime.DtsTaskAttribute>|<xref:Microsoft.SqlServer.Dts.Runtime.Task.Execute%2A>|
...
## <a name="see-also"></a>Weitere Informationen
 Beibehalten von [benutzerdefinierten Objekten](persisting-custom-objects.md) entwickeln, bereitstellen [und Debuggen von benutzerdefinierten Objekten](building-deploying-and-debugging-custom-objects.md)
