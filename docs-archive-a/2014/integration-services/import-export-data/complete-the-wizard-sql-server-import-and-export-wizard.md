...
# <a name="complete-the-wizard-sql-server-import-and-export-wizard"></a>Assistenten abschließen (SQL Server-Import/Export-Assistent)
  Verwenden Sie die Seite **Assistenten vervollständigen** , um die Optionen zu bestätigen, die Sie im Assistenten vor dem Kopieren der Daten vorgenommen haben.  
...
-   Die Aktionen, die vom Assistenten ausgeführt werden, z. B. welche Daten kopiert werden, ob das Paket gespeichert wird, und ob das Paket sofort ausgeführt wird.  
