...
4.  Verwenden Sie im Code `Imports`-Anweisungen, um die Namespaces `System.Drawing` und `System.IO` zu importieren.  
...
5.  Verwenden Sie im Code `Imports`-Anweisungen, um die Namespaces `System.Drawing` und `System.IO` zu importieren.  
