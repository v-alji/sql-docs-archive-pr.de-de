 ...
 **/M** _machine1_ [ *machine2 * * Machinen*] |*@machinelistfile*  
 ...
 Mithilfe *@machinelistfile* von wird ein Computer Listen Dateiname angegeben, der in der Konfigurationsdatei gespeichert werden soll.  
