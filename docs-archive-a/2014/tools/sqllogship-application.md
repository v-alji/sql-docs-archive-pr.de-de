...
# <a name="sqllogship-application"></a>Anwendung sqllogship
 ...
 ![Symbol für Themenlink](../../2014/database-engine/media/topic-link.gif "Symbol für Themenlink") Informationen zu den Syntaxkonventionen finden Sie unter [Referenz zum Eingabeaufforderungs-Hilfsprogramm &#40;Datenbank-Engine&#41;](../tools/command-prompt-utility-reference-database-engine.md).  
...
## <a name="remarks"></a>Bemerkungen  
 ...
 Die **sqllogship** -Anwendung, SqlLogShip.exe, wird im Verzeichnis "x:\Programme\Microsoft SQL server\120\tools\binn" installiert.  
