...
# <a name="numberofflags-property-sinstance-class"></a>NumberOfFlags-Eigenschaft (SInstance-Klasse)
  Ruft die Anzahl der Flags für die-Instanz ab [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] .  
...
## <a name="property-valuereturn-value"></a>Eigenschaftswert/Rückgabewert  
 Ein `uint32`-Wert, der die Anzahl von Flags für die Instanz von [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] angibt.  
