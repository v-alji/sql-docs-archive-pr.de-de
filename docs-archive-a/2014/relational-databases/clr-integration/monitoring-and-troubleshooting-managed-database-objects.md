...
|[SP: Starting-Ereignisklasse](../event-classes/sp-starting-event-class.md), [SP: Abgeschlossene Ereignisklasse](../event-classes/sp-completed-event-class.md)|Wird verwendet, um die Ausführung von gespeicherten [!INCLUDE[tsql](../../../includes/tsql-md.md)]-Prozeduren zu überwachen.|  
|[SQL: StmtStarting-Ereignisklasse](../event-classes/sql-stmtstarting-event-class.md), [SQL: stmtabgeschlossene-Ereignisklasse](../event-classes/sql-stmtcompleted-event-class.md)|Wird verwendet, um die Ausführung von CLR- und [!INCLUDE[tsql](../../../includes/tsql-md.md)]-Routinen zu überwachen.|  
