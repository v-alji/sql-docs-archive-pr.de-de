...
>  Eine [!INCLUDE[tsql](../../includes/tsql-md.md)] SELECT-Anweisung, die eine COMPUTE-Klausel enthält, wird nur beim Herstellen einer Verbindung zu einer Serverversion vor [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]unterstützt.  
 ...
 Der Entwickler kann die Eigenschaften der Resultset-Spalten und -Zeilen bestimmen, die mit der COMPUTE-Klausel einer [!INCLUDE[tsql](../../includes/tsql-md.md)] SELECT-Anweisung erstellt werden. Weitere Informationen finden Sie unter [SQLColAttribute](sqlcolattribute.md).  
