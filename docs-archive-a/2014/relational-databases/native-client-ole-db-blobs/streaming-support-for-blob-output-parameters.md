...
ms.locfileid: "87725597"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="1c0e5-102">Streamingunterstützung für BLOB-Ausgabeparameter</span><span class="sxs-lookup"><span data-stu-id="1c0e5-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="1c0e5-103">Dieses Thema enthält ein Beispiel, das die Streamingunterstützung für BLOB-Ausgabeparameter zeigt und das BLOB-Ausgabeparameter als IsequentialStreams bindet.</span><span class="sxs-lookup"><span data-stu-id="1c0e5-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="1c0e5-104">Sie können auf Ausgabeparametern in IMultipleResults::GetResult blockiert werden, wenn der DB_E_OBJECTOPEN-Rückgabewert empfangen wird.</span><span class="sxs-lookup"><span data-stu-id="1c0e5-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="1c0e5-105">Der Aufrufer sollte ausstehende BLOB-Parameter überprüfen und sie entweder vollständig lesen oder freigeben.</span><span class="sxs-lookup"><span data-stu-id="1c0e5-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="1c0e5-106">Beispiel</span><span class="sxs-lookup"><span data-stu-id="1c0e5-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="1c0e5-107">Code</span><span class="sxs-lookup"><span data-stu-id="1c0e5-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="1c0e5-108">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="1c0e5-108">See Also</span></span>  
 [<span data-ttu-id="1c0e5-109">BLOBs und OLE-Objekte</span><span class="sxs-lookup"><span data-stu-id="1c0e5-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
