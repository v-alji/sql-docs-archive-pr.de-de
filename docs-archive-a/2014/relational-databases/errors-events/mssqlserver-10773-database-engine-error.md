...
|Symbolischer Name|P3_HEKATON_PROC_IMP|  
|Meldungstext|Das *construct*-*Funktion* wurde bei systemintern kompilierten gespeicherten Prozeduren noch nicht implementiert.|  
