...
|----------------------|-----------|  
|Beschreibt, wie ein Ressourcenpool erstellt wird.|[Erstellen eines Ressourcenpools](create-a-resource-pool.md)|  
|Beschreibt, wie Ressourcenpooleinstellungen geändert werden.|[Ändern der Einstellungen für den Ressourcenpool](change-resource-pool-settings.md)|  
|Beschreibt, wie ein Ressourcenpool gelöscht wird.|[Löschen eines Ressourcenpools](delete-a-resource-pool.md)|  
