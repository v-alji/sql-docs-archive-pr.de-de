 ...
 **Automatisches Geografieraster**  
 ...
 Informationen darüber, wie in [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ein Mosaik implementiert wird, finden Sie unter [Räumliche Daten &#40;SQL Server&#41;](../spatial/spatial-data-sql-server.md).  
