...
```  
 ...
 Sie können einen benutzerdefinierten NEAR-Begriff nicht mit einem generischen NEAR-Begriff (*Begriff1* near *Begriff2*), einem Generierungs Begriff (ISABOUT...) oder einem gewichteten Begriff (FORMSOF...) kombinieren.  
