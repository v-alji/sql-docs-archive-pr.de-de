...
|Platform|Schätzen der fdhost.exe Arbeitsspeicher Anforderungen in MB-*F*<sup>1</sup>|Formel zum Berechnen des maximalen Server Arbeitsspeichers-*M*<sup>2</sup>|  
|--------------|---------------------------------------------------------------------|---------------------------------------------------------------|  
 ...
 **Beispiel: Festlegen des maximalen Serverarbeitsspeichers**  
