...
```  
 ...
 Im folgenden Beispiel wird ein XML-Index für eine Spalte vom Typ `xml` erstellt: Weitere Informationen finden Sie unter [Vergleichen von typisiertem XML mit nicht typisiertem XML](../xml/compare-typed-xml-to-untyped-xml.md).  
