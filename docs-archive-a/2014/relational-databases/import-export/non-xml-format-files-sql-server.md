...
-   Sie können eine Formatdatei für einen bestimmten Datentyp z. B. Zeichendaten oder systemeigene Daten erstellen.  
     ...
     Sie können Nicht-XML-Formatdateien erstellen, die interaktiv angegebene Attribute für jedes Datenfeld enthalten. Weitere Informationen finden Sie unter [Angeben von Datenformaten für die Kompatibilität bei Verwendung von „bcp“ &#40;SQL Server&#41;](specify-data-formats-for-compatibility-when-using-bcp-sql-server.md).  
...
##  <a name="structure-of-non-xml-format-files"></a><a name="Structure"></a> Struktur von Nicht-XML-Formatdateien  
 ...
 ![Identifiziert die Felder einer Datei, die nicht im XML-Format vorliegt](../../database-engine/media/mydepart-fmt-ident-c.gif "Identifiziert die Felder einer Datei, die nicht im XML-Format vorliegt")  
