...
```  
 ...
 Weitere Informationen zur CURRENT_USER-Anweisung finden Sie unter [CURRENT_USER &#40;Transact-SQL&#41;](/sql/t-sql/functions/current-user-transact-sql).  
...
##  <a name="complete-example"></a><a name="CompleteExample"></a>Vervollständigen eines Beispiels  
