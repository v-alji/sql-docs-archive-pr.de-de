...
-   Mit dem ** \@ identity_range** -Parameter wird die Größe des Identitäts Bereichs gesteuert, der dem Verleger und den Abonnenten mit Client Abonnements anfänglich zugeordnet wird.  
    ...
    > [!NOTE]  
    >  Bei Abonnenten, die frühere Versionen von ausführen [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] , steuert dieser Parameter (anstelle des Parameters ** \@ pub_identity_range** ) auch die Größe des Identitäts Bereichs bei wieder Veröffentlichungs Abonnenten.  
...
-   Der ** \@ Schwellenwert** Parameter, der verwendet wird, um zu bestimmen, wann ein neuer Identitäts Bereich für ein Abonnement von [!INCLUDE[ssEW](../../../includes/ssew-md.md)] oder eine frühere Version von erforderlich ist [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] .  
