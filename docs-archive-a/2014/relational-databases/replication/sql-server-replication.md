...
## <a name="administeration"></a>Verwaltung 
...
-   [Bereinigen von zusammenlaufmetadaten](administration/clean-up-merge-metadata-replication-transact-sql-programming.md)    
-   [Ausführen eines Pseudo Updates für einen Mergeartikel](administration/perform-a-dummy-update-for-a-merge-article-replication-transact-sql-programming.md)    
...
-   [Aktivieren koordinierter Sicherungen für die Transaktionsreplikation](administration/enable-coordinated-backups-for-transactional-replication.md)   
...
-   [Versetzen einer Replikations Topologie in einen inaktiven Status](administration/quiesce-a-replication-topology-replication-transact-sql-programming.md)    
