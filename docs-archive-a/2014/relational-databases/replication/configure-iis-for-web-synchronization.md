...
1.  Erstellen Sie ein Dateiverzeichnis auf dem Computer mit IIS, in dem die Datei replisapi.dll enthalten sein soll. Dieses Verzeichnis kann an einem beliebigen Ort erstellt werden, es wird jedoch die Erstellung im Verzeichnis \<*drive*>:\Inetpub empfohlen. Erstellen Sie z. B. das Verzeichnis \<*drive*>:\Inetpub\SQLReplication\\.  
...
5.  Ordnen Sie das Konto dem Anwendungspool zu:  
    ...
    3.  Klicken Sie im Dialogfeld ** \<ApplicationPoolName> Eigenschaften** auf der Registerkarte **Identität** auf **konfigurierbar**.  
