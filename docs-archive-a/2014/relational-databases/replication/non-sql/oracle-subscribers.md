...
## <a name="considerations-for-oracle-subscribers"></a>Überlegungen zu Oracle-Abonnenten  
 Abgesehen von den unter dem Thema [Non-SQL Server Subscribers](non-sql-server-subscribers.md)angestellten Überlegungen sollten Sie bei der Replikation auf Oracle-Abonnenten folgende Aspekte berücksichtigen:  
...
-   Oracle-Abonnenten unterstützen eine Schemaoption von 0x4071. Weitere Informationen zu den Schemaoptionen finden Sie unter [sp_addarticle &#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/sp-addarticle-transact-sql).  
