...
-   Das Konto wird zunächst mithilfe der [!INCLUDE[tsql](../../../includes/tsql-md.md)]-Anweisung [CREATE CREDENTIAL](/sql/t-sql/statements/create-credential-transact-sql) Anmeldeinformationen zugeordnet. Von[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] -Agent-Proxys werden Anmeldeinformationen zum Speichern von Informationen zu Windows-Benutzerkonten verwendet.  
