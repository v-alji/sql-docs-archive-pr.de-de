...
|Meldungstext|Fehler beim Abrufen der lokalisierten Fehlermeldung. Der angegebene Fehlercode ist unbekannt.|  
  
## <a name="explanation"></a>Erklärung  
 Der angeforderte Fehlercode ist unbekannt.  
  
## <a name="user-action"></a>Benutzeraktion  
 Überprüfen Sie, ob der angegebene Fehlercode richtig ist.  
