...
|Beschreibt, wie das Abfrageparametrisierungs-Verhalten mit Planhinweislisten gesteuert wird.|[Angeben des Abfrageparametrisierungsverhaltens mithilfe von Planhinweislisten](specify-query-parameterization-behavior-by-using-plan-guides.md)|  
