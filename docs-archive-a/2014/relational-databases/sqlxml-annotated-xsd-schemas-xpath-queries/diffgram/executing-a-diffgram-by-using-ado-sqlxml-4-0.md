...
1.  Kopieren Sie in einen Ordner auf Ihrem Computer eines der Diffgrams und das entsprechende XSD-Schema aus einem der Beispiele in [DiffGram-Beispielen](diffgram-examples-sqlxml-4-0.md).  
