...
## <a name="dealing-with-data-types"></a>Umgehen mit Datentypen  
 ...
 Beim Verarbeiten von Parametern des [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] `money` Typs müssen Sie explizit `sql:datatype="money"` auf dem entsprechenden Knoten im Zuordnungsschema angeben.  
