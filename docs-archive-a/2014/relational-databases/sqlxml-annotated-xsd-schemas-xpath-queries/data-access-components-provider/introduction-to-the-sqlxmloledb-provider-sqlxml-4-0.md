...
|Verbindung<br /><br /> property|Standardwert<br /><br /> (ggf.)|BESCHREIBUNG|  
|-----------------------------|----------------------------|-----------------|  
...
|Get-Help<br /><br /> property|Standardwert<br /><br /> (ggf.)|BESCHREIBUNG|  
|--------------------------|----------------------------|-----------------|  
...
|Namespaces||Diese Eigenschaft ermöglicht die Ausführung von XPath-Abfragen, die Namespaces verwenden. Ein Beispiel für die Verwendung dieser Eigenschaft finden Sie unter [Ausführen von XPath-Abfragen mit Namespaces &#40;SQLXMLOLEDB-Anbieter&#41;](executing-xpath-queries-with-namespaces-sqlxmloledb-provider.md).|  
