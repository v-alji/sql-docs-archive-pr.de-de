...
```  
 ...
 Mit der folgenden [!INCLUDE[tsql](../../includes/tsql-md.md)] Anweisung wird die Assembly mithilfe *<assembly_bits>* -Arguments in der from-Klausel registriert. Dieser `varbinary`-Wert stellt die Datei als Byte-Datenstrom dar.  
