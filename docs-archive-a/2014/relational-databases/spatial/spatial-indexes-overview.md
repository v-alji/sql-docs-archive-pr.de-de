...
###  <a name="decomposing-indexed-space-into-a-grid-hierarchy"></a><a name="decompose"></a> Zerlegen von indiziertem Raum in eine Rasterhierarchie
 ...
 ![Vier Ebenen des rekursiven Mosaiks](../../database-engine/media/spndx-recursive-levels-telescoped.gif "Vier Ebenen des rekursiven Mosaiks")
...
>  Die Zerlegung des Raums in einen räumlichen Index ist unabhängig von der Maßeinheit, die die Anwendung verwendet.
 ...
 ![Polygone und Linien, platziert in einem 4x4-Raster der Ebene 1](../../database-engine/media/spndx-level-1-objects.gif "Polygone und Linien, platziert in einem 4x4-Raster der Ebene 1")
...
#### <a name="covering-rule"></a>Überlagerungsregel
 ...
 ![Überlagerungsoptimierung](../../database-engine/media/spndx-opt-covering.gif "Überlagerungsoptimierung")
...
#### <a name="deepest-cell-rule"></a>Tiefste-Zelle-Regel
 ...
 ![Tiefste-Zelle-Optimierung](../../database-engine/media/spndx-opt-deepest-cell.gif "Tiefste-Zelle-Optimierung")
...
-   *Geometrie Raster*Mosaik, das das Schema für den `geometry` Datentyp darstellt.

-   *Geografieraster*-Mosaik, das für Spalten des- `geography` Datentyps gilt.
...
3.  Die vereinfachten Pyramiden werden verbunden, sodass sie eine nicht-euklidische Ebene bilden.
 ...
 ![Projektion des Ellipsoids auf eine Ebene](../../database-engine/media/spndx-geodetic-projection.gif "Projektion des Ellipsoids auf eine Ebene")
 ...
 ![Geografieraster der Ebene 1](../../database-engine/media/spndx-geodetic-level1grid.gif "Geografieraster der Ebene 1")
...
-   *Geometry1*. [STDistance](/sql/t-sql/spatial-geometry/stdistance-geometry-data-type)(*Geometry2*) < *Nummer*
...
-   *geography1*. [STDistance](/sql/t-sql/spatial-geography/stdistance-geography-data-type)(*geography2*) < *Nummer*
