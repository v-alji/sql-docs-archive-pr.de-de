...
-   [Kerberos – Technische Ergänzungfür Windows](https://go.microsoft.com/fwlink/?LinkId=101449)  
...
|Syntax|BESCHREIBUNG|  
|------------|-----------------|  
|MSSQLSvc/*voll* ständig verfügbar|Der vom Anbieter erstellte Standard-SPN für eine Standardinstanz, wenn ein anderes Protokoll als TCP verwendet wird.<br /><br /> *FQDN* ist ein voll qualifizierter Domänen Name.|  
...
|*Benutzername* @ *Domäne*|Direkte Spezifikation eines Domänenkontos.<br /><br /> *Username* ist der Name des Windows-Benutzerkontos.<br /><br /> *Domain* ist ein Windows-Domänenname oder ein vollqualifizierter Domänenname.|  
|*MachineName* $@ *Domäne*|Ein Computerkonto wird direkt angegeben.<br /><br /> (Wenn der Server, mit dem Sie eine Verbindung herstellen, unter "Lokales System" oder Netzwerkdienst Konto ausgeführt wird, kann zum erhalten der Kerberos-Authentifizierung `ServerSPN` das Domänen Format " *MachineName*" aufweisen $@ *Domain* .)|  
...
-   [Dienstprinzipalnamen (SPN) in Clientverbindungen (ODBC)](../odbc/service-principal-names-spns-in-client-connections-odbc.md)  
  
-   [Dienstprinzipalnamen (SPN) in Clientverbindungen (OLE DB)](../ole-db/service-principal-names-spns-in-client-connections-ole-db.md)  
