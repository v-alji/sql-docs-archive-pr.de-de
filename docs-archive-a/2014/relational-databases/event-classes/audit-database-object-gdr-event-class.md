...
# <a name="audit-database-object-gdr-event-class"></a>Audit Database Object GDR (Ereignisklasse)
  Die **Audit Database Object GDR** -Ereignisklasse tritt auf, wenn für Datenbankobjekte, z. B. Assemblys und Schemas, eine GRANT-, REVOKE- oder DENY-Anweisung ausgegeben wurde.  
