...
---
# <a name="audit-login-change-password-event-class"></a>Audit Login Change Password-Ereignisklasse
  Die Ereignisklasse **Audit Login Change Password** tritt auf, wenn ein Benutzer sein Kennwort für die [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Anmeldung ändert.  
  
## <a name="audit-login-change-password-event-class-data-columns"></a>Datenspalten der Audit Login Change Password-Ereignisklasse  
...
|**EventClass**|**int**|Ereignistyp = 107.|27|Nein|  
|**EventSequence**|**int**|Sequenz eines bestimmten Ereignisses innerhalb der Anforderung.|51|Nein|  
|**EventSubClass**|**int**|Der Typ der Ereignisunterklasse.<br /><br /> 1 = Kennwort automatisch geändert<br /><br /> 2 = Kennwort geändert<br /><br /> 3 = Kennwort automatisch zurückgesetzt<br /><br /> 4 = Kennwort zurückgesetzt<br /><br /> 5 = Kennwortsperre aufgehoben<br /><br /> 6 = Kennwort muss geändert werden|21|Ja|  
