...
---
# <a name="exception-event-class"></a>Exception-Ereignisklasse
...
## <a name="exception-event-class-data-columns"></a>Datenspalten der Exception-Ereignisklasse  
...
|State|`int`|Der Status des Servers.|30|Ja|  
