...
|**BinaryData**|**image**|Anzahl der CPUs, die zum Abschließen des Prozesses auf der Grundlage der folgenden Werte verwendet werden:<br /><br /> 0x00000000: gibt einen seriellen Plan an, der seriell ausgeführt wird.<br /><br /> 0x01000000 gibt einen parallelen Plan an, der seriell ausgeführt wird.<br /><br /> >= 0x02000000: gibt einen parallelen Plan an, der parallel ausgeführt wird.|2|Nein|  
