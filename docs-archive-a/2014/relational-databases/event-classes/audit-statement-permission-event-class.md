...
## <a name="audit-statement-permission-event-class-data-columns"></a>Audit Statement Permission (Ereignisklasse-Datenspalten)  
...
|**EventClass**|**int**|Ereignistyp = 113.|27|Nein|  
...
|**Berechtigungen**|**bigint**|Wert für ganze Zahl, der den Typ der überprüften Berechtigungen darstellt.<br /><br /> 1 = CREATE DATABASE (nur master-Datenbank)<br /><br /> 2 = CREATE TABLE<br /><br /> 4 = CREATE PROCEDURE<br /><br /> 8 = CREATE VIEW<br /><br /> 16 = CREATE RULE<br /><br /> 32 = CREATE DEFAULT<br /><br /> 64 = BACKUP DATABASE<br /><br /> 128 = BACKUP LOG<br /><br /> 256 = BACKUP TABLE<br /><br /> 512 = CREATE FUNCTION|19|Ja|  
...
|**TextData**|**ntext**|Der SQL-Text der Anweisung, die Anweisungsberechtigungen erfordert.|1|Ja|  
