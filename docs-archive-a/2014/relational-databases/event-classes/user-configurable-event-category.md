...
|Thema|BESCHREIBUNG|  
|-----------|-----------------|  
|[Benutzerkonfigurierbar-Ereignisklasse](user-configurable-event-class.md)|Zum Überwachen von benutzerdefinierten Ereignissen, die nicht mithilfe der vom System in anderen Ereigniskategorien bereitgestellten Ereignisse überwacht werden können.|  
