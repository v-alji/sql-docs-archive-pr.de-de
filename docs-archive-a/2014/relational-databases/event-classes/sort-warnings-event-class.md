...
## <a name="sort-warnings-event-class-data-columns"></a>Sort Warnings-Ereignisklasse (Datenspalten)  
...
|EventClass|`int`|Ereignistyp = 69.|27|Nein|  
|EventSequence|`int`|Die Sequenz eines bestimmten Ereignisses innerhalb der Anforderung.|51|Nein|  
|EventSubClass|`int`|Der Typ der Ereignisunterklasse.<br /><br /> 1 = Einzelner Durchlauf. Als die Sortiertabelle auf den Datenträger geschrieben wurde, war für die sortierte Ausgabe nur ein einzelner zusätzlicher Datendurchlauf erforderlich.<br /><br /> 2 = Mehrere Durchläufe. Als die Sortiertabelle auf den Datenträger geschrieben wurde, waren für die sortierte Ausgabe mehrere Datendurchläufe erforderlich.|21|Ja|  
