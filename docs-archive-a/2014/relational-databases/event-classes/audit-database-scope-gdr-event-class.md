...
# <a name="audit-database-scope-gdr-event-class"></a>Audit Database Scope GDR (Ereignisklasse)
  Die Ereignisklasse **Audit Database Scope GDR** tritt immer auf, wenn Benutzer in [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] für ausschließlich datenbankrelevante Vorgänge wie beispielsweise das Gewähren von Berechtigungen für eine Datenbank GRANT-, REVOKE- oder DENY für eine Anweisungsberechtigung ausgeben.  
