...
## <a name="lock-released-event-class-data-columns"></a>Datenspalten der Lock:Released-Ereignisklasse  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Lock: erworbene (Ereignisklasse)](lock-acquired-event-class.md)   
