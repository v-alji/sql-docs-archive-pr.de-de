...
|EventSubClass|`int`|Der Typ der Ereignisunterklasse:<br /><br /> 1 = Compplan entfernen. Ein kompilierter Abfrageplan wurde aus dem Cache entfernt.<br /><br /> 2 = proc Cache Flush. Alle Einträge wurden aus dem Prozedurcache entfernt.|21|Ja|  
