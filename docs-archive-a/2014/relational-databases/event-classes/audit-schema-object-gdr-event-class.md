...
# <a name="audit-schema-object-gdr-event-class"></a>Audit Schema Object GDR-Ereignisklasse
  Die Ereignisklasse **Audit Schema Object GDR** tritt auf, wenn ein Benutzer in [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] eine GRANT-, REVOKE- oder DENY-Anweisung für eine Schemaobjektberechtigung ausgibt.  
...
|**ColumnPermissions**|**int**|Zeigt an, ob eine Spaltenberechtigung festgelegt wurde. Analysieren Sie den Text der Anweisung, um genau zu ermitteln, welche Berechtigungen auf welche Spalten angewendet wurden. 1=Ja, 0=Nein.|44|Ja|  
...
|**EventClass**|**int**|Ereignistyp = 103.|27|Nein|  
...
|**ObjectName**|**nvarchar**|Name des Objekts, das das Ziel der Anweisung GRANT, REVOKE oder DENY ist.|34|Ja|  
