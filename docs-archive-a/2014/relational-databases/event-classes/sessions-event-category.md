...
---
# <a name="sessions-event-category"></a>Sessions-Ereigniskategorie
...
|Thema|BESCHREIBUNG|  
|-----------|-----------------|  
|[ExistingConnection (Ereignisklasse)](existingconnection-event-class.md)|Zeigt die Eigenschaften von Benutzerverbindungen an, die beim Starten der Ablaufverfolgung vorhanden waren.|  
