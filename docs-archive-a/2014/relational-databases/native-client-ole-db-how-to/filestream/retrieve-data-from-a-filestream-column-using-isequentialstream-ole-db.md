...
-   [Senden von Daten an eine FILESTREAM-Spalte mithilfe von IRowsetFastUpload &#40;OLE DB&#41;](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
 ...
 Kopieren Sie das dritte Codelisting, und fügen Sie es in eine Datei mit dem Namen ICommandDownload.cpp ein.  
  
 Kompilieren Sie ICommandDownload.cpp, ISSHelper.cpp, ole32.lib und oleaut32.lib.  
  
 Wenn dieses Beispiel ausgeführt wird, müssen Sie einen Servernamen (oder server\instance_name) übergeben.  
