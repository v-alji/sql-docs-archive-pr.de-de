---
title: Lesen einer FILESTREAM-Spalte in eine Datei mithilfe von IBCPSession (OLE DB) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "87696833"
---
# <a name="read-a-filestream-column-to-file-using-ibcpsession-ole-db"></a><span data-ttu-id="7a293-102">Lesen einer FILESTREAM-Spalte in eine Datei mithilfe von IBCPSession (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="7a293-102">Read a FILESTREAM Column to File Using IBCPSession (OLE DB)</span></span>
  <span data-ttu-id="7a293-103">Dieses Beispiel liest mithilfe der IBCPSession-Schnittstelle eine FILESTREAM-Spalte in eine Datei und schreibt eine Formatdatei.</span><span class="sxs-lookup"><span data-stu-id="7a293-103">This sample reads a filestream column to a file using the IBCPSession interface and writes a format file.</span></span>  
  
 <span data-ttu-id="7a293-104">Weitere Informationen zur FILESTREAM-Funktion finden Sie [unter FILESTREAM-Unterstützung &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="7a293-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="7a293-105">Beispiel</span><span class="sxs-lookup"><span data-stu-id="7a293-105">Example</span></span>  
 <span data-ttu-id="7a293-106">Stellen Sie sicher, dass die INCLUDE-Umgebungsvariable das Verzeichnis einschließt, das sqlncli.h enthält.</span><span class="sxs-lookup"><span data-stu-id="7a293-106">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="7a293-107">Erstellen Sie die Tabelle, aus der in diesem Beispiel gelesen wird, mithilfe eines der folgenden Beispiele:</span><span class="sxs-lookup"><span data-stu-id="7a293-107">Use one of the following samples to create the table that this sample reads from:</span></span>  
  
-   [<span data-ttu-id="7a293-108">Senden von Daten an eine FILESTREAM-Spalte mithilfe von ISequentialStream, das an einen ICommandText-Parameter gebunden ist &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="7a293-108">Send Data to a FILESTREAM Column Using ISequentialStream Bound to ICommandText Parameter &#40;OLE DB&#41;</span></span>](send-data-to-filestream-isequentialstream-bound-to-icommandtext.md)  
  
-   [<span data-ttu-id="7a293-109">Senden von Daten an eine FILESTREAM-Spalte mithilfe von IRowsetFastUpload &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="7a293-109">Send Data to a FILESTREAM Column Using IRowsetFastUpload &#40;OLE DB&#41;</span></span>](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
  
 <span data-ttu-id="7a293-110">Kopieren Sie das erste Codelisting, und fügen Sie es in eine Datei mit dem Namen ISSHelper.h ein.</span><span class="sxs-lookup"><span data-stu-id="7a293-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="7a293-111">Kopieren Sie das zweite Codelisting, und fügen Sie es in eine Datei mit dem Namen ISSHelper.cpp ein.</span><span class="sxs-lookup"><span data-stu-id="7a293-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="7a293-112">Kopieren Sie das dritte Codelisting, und fügen Sie es in eine Datei mit dem Namen IBCPSession.cpp ein.</span><span class="sxs-lookup"><span data-stu-id="7a293-112">Copy the third code listing and paste it into a file called IBCPSession.cpp.</span></span>  
  
 <span data-ttu-id="7a293-113">Kompilieren Sie IBCPSession.cpp, ISSHelper.cpp, ole32.lib und oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="7a293-113">Compile IBCPSession.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="7a293-114">Wenn dieses Beispiel ausgeführt wird, müssen Sie einen Servernamen (oder server\instance_name) sowie einen Namen für die Formatdatei übergehen, die erstellt wird.</span><span class="sxs-lookup"><span data-stu-id="7a293-114">When this sample is run, you must pass a server name (or server\instance_name) and a name for the format file it will create.</span></span>  
