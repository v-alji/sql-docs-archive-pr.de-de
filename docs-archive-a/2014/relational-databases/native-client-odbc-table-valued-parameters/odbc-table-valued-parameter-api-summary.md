...
---
# <a name="odbc-table-valued-parameter-api-summary"></a>Zusammenfassung der ODBC-Tabellenwertparameter-API
  In diesem Thema werden die ODBC-Funktionen aufgeführt, die verbessert wurden, sodass nun Tabellenwertparameter unterstützt werden.  
