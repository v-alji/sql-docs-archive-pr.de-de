...
## <a name="using-odbc-to-execute-a-natively-complied-stored-procedure"></a>Ausführen einer systemintern kompilierten gespeicherten Prozedur mithilfe von ODBC  
