...
### <a name="create-the-database"></a>Erstellen der Datenbank  
 Durch folgende [!INCLUDE[tsql](../../includes/tsql-md.md)] wird eine Datenbank mit dem Namen "IMOLTP_DB" erstellt, die mindestens eine speicheroptimierte Tabelle enthält. Der Pfad \<driveAndPath> muss vor der Ausführung dieses Befehls vorhanden sein.  
...
### <a name="create-a-resource-pool-and-configure-memory"></a>Erstellen eines Ressourcenpools und Konfigurieren des Arbeitsspeichers  
 ...
 Unter [Bewährte Methoden: Verwenden von In-Memory OLTP in einer Umgebung mit virtuellen Computern](../../database-engine/using-in-memory-oltp-in-a-vm-environment.md) finden Sie weitere Informationen, wenn Sie in einer VM-Umgebung arbeiten.  
