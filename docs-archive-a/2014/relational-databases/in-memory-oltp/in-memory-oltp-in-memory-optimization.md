...
|||
|-|-|
|![Virtuelle Azure-Computer](../../master-data-services/media/azure-virtual-machine.png "Virtueller Azure-Computer")|Möchten Sie SQL Server 2016 testen? Melden Sie sich für Microsoft Azure an, und wechseln Sie dann **[hier](https://azuremarketplace.microsoft.com/marketplace/apps/microsoftsqlserver.sql2017-ws2019?tab=Overview)** , um einen virtuellen Computer zu starten, auf dem bereits SQL Server 2016 installiert ist. Sie können den virtuellen Computer löschen, wenn Sie fertig sind.|
