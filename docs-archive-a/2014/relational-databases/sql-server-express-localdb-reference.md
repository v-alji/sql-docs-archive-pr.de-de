...
ms.locfileid: "87619051"
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="1f330-102">SQL Server Express LocalDB-Verweis</span><span class="sxs-lookup"><span data-stu-id="1f330-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="1f330-103">Dieser Abschnitt enthält Informationen zu SQL Server Express LocalDB:</span><span class="sxs-lookup"><span data-stu-id="1f330-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="1f330-104">SQL Server Express LocalDB-Fehlermeldungsverweis</span><span class="sxs-lookup"><span data-stu-id="1f330-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="1f330-105">SQL Server Express LocalDB-Instanz-API-Verweis</span><span class="sxs-lookup"><span data-stu-id="1f330-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="1f330-106">Codebeispiel</span><span class="sxs-lookup"><span data-stu-id="1f330-106">Code Sample</span></span>  
 <span data-ttu-id="1f330-107">Im folgenden Beispiel wird die LocalDB-API veranschaulicht.</span><span class="sxs-lookup"><span data-stu-id="1f330-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="1f330-108">Stellen Sie sicher, dass LocalDB vor dem Ausführen dieses Beispiels auf dem Computer installiert wird.</span><span class="sxs-lookup"><span data-stu-id="1f330-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="1f330-109">Sie können LocalDB in [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express mithilfe von Setup installieren.</span><span class="sxs-lookup"><span data-stu-id="1f330-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
