...
ms.locfileid: "87608622"
---
# <a name="use-table-valued-parameters-odbc"></a><span data-ttu-id="253d2-102">Verwenden von Tabellenwertparametern (ODBC)</span><span class="sxs-lookup"><span data-stu-id="253d2-102">Use Table-Valued Parameters (ODBC)</span></span>
  <span data-ttu-id="253d2-103">In diesem Beispiel wird veranschaulicht, wie mit Tabellenwertparametern mehrere Zeilen mit mehreren Spalten und einem Aufruf des Servers eingefügt werden.</span><span class="sxs-lookup"><span data-stu-id="253d2-103">This sample shows how to use table-valued parameters to insert multiple rows, with multiple columns, with one call to the server.</span></span>  
  
 <span data-ttu-id="253d2-104">Weitere Informationen zu Tabellenwert Parametern finden Sie unter [Tabellenwert Parameter &#40;ODBC-&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span><span class="sxs-lookup"><span data-stu-id="253d2-104">For more information about table-valued parameters, see [Table-Valued Parameters &#40;ODBC&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span></span> <span data-ttu-id="253d2-105">Weitere Beispiele mit Tabellenwertparametern finden Sie unter [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span><span class="sxs-lookup"><span data-stu-id="253d2-105">For more samples using table-valued parameters, see [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="253d2-106">Beispiel</span><span class="sxs-lookup"><span data-stu-id="253d2-106">Example</span></span>  
 <span data-ttu-id="253d2-107">Sie benötigen eine ODBC-Datenquelle mit dem Namen TVPDemo.</span><span class="sxs-lookup"><span data-stu-id="253d2-107">You will need an ODBC data source called TVPDemo.</span></span> <span data-ttu-id="253d2-108">Die Standarddatenbank für TVPDemo kann jede Testdatenbank auf dem Computer sein.</span><span class="sxs-lookup"><span data-stu-id="253d2-108">The default database for TVPDemo can be any test database on your computer.</span></span> <span data-ttu-id="253d2-109">Diese Datenquelle muss auf dem ODBC-Treiber für [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Native Client basieren.</span><span class="sxs-lookup"><span data-stu-id="253d2-109">This data source must be based on the ODBC driver for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span></span>  
  
 <span data-ttu-id="253d2-110">Wenn Sie dieses Beispiel als 32-Bit-Anwendung entwickeln und unter einem 64-Bit-Betriebssystem ausführen, müssen Sie die ODBC-Datenquelle mit dem ODBC-Administrator in %windir%\SysWOW64\odbcad32.exe erstellen.</span><span class="sxs-lookup"><span data-stu-id="253d2-110">If you will build and run this sample as a 32-bit application on a 64-bit operating system, you must create the ODBC data source with the ODBC Administrator in %windir%\SysWOW64\odbcad32.exe.</span></span>  
  
 <span data-ttu-id="253d2-111">In diesem Beispiel wird eine Verbindung mit der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Standardinstanz des Computers hergestellt.</span><span class="sxs-lookup"><span data-stu-id="253d2-111">This sample connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="253d2-112">Ändern Sie zum Herstellen einer Verbindung mit einer benannten Instanz die Definition der ODBC-Datenquelle, um die Instanz im folgenden Format anzugeben: Server\benannteInstanz.</span><span class="sxs-lookup"><span data-stu-id="253d2-112">To connect to a named instance, change the definition of the ODBC data source to specify the instance using the following format: server\namedinstance.</span></span> <span data-ttu-id="253d2-113">Standardmäßig wird [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] in einer benannten Instanz installiert.</span><span class="sxs-lookup"><span data-stu-id="253d2-113">By default, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] installs to a named instance.</span></span>  
  
 <span data-ttu-id="253d2-114">Kompilieren Sie das Codelisting (C++) mit odbc32.lib und user32.lib.</span><span class="sxs-lookup"><span data-stu-id="253d2-114">Compile the (C++) code listing with odbc32.lib and user32.lib.</span></span> <span data-ttu-id="253d2-115">Stellen Sie sicher, dass die INCLUDE-Umgebungsvariable das Verzeichnis einschließt, das sqlncli.h enthält.</span><span class="sxs-lookup"><span data-stu-id="253d2-115">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
