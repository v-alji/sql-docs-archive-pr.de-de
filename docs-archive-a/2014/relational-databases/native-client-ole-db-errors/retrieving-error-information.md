...
ms.locfileid: "87620842"
---
# <a name="retrieving-error-information"></a><span data-ttu-id="22da8-102">Abrufen von Fehlerinformationen</span><span class="sxs-lookup"><span data-stu-id="22da8-102">Retrieving Error Information</span></span>
  <span data-ttu-id="22da8-103">In diesem Beispiel werden Informationen aus den verschiedenen Fehler Schnittstellen abgerufen, die vom [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client-OLE DB Anbieter verfügbar gemacht werden.</span><span class="sxs-lookup"><span data-stu-id="22da8-103">This example obtains information from the various error interfaces exposed by the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="22da8-104">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="22da8-104">See Also</span></span>  
 [<span data-ttu-id="22da8-105">Fehler</span><span class="sxs-lookup"><span data-stu-id="22da8-105">Errors</span></span>](errors.md)  
