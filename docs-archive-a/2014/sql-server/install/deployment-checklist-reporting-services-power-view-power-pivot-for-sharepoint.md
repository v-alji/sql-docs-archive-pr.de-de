...
|Installieren Sie SharePoint Server 2010 SP1.|Laden Sie SP1 von herunter [https://support.microsoft.com/kb/2460045](https://go.microsoft.com/fwlink/p/?linkID=219697) .|  
...
|Überprüfen Sie, ob die Farm betriebsbereit ist.|Starten Sie zuerst die Zentraladministration, und vergewissern Sie sich, dass diese verfügbar ist. Öffnen Sie als nächstes die Team Website, indem Sie eingeben http://localhost .  Es sollte eine SharePoint-Teamwebsite angezeigt werden.|  
