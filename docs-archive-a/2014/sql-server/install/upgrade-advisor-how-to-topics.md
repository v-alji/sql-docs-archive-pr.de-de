...
# <a name="upgrade-advisor-how-to-topics"></a>Themen zur Vorgehensweise für den Upgrade Advisor
  Dieser Abschnitt enthält allgemeine Verfahren zum Verwenden des Upgrade Advisors.  
  
## <a name="in-this-section"></a>In diesem Abschnitt  
 [Gewusst wie: Installieren des Upgrade Advisors](../../../2014/sql-server/install/how-to-install-upgrade-advisor.md)  
  
 [Gewusst wie: Starten des Upgrade Advisors](../../../2014/sql-server/install/how-to-launch-upgrade-advisor.md)  
  
 [Gewusst wie: Ausführen des Analyse-Assistenten des Upgrade Advisors](../../../2014/sql-server/install/how-to-run-the-upgrade-advisor-analysis-wizard.md)  
