...
# <a name="replication-upgrade-issues"></a>Probleme beim Replikationsupgrade
  In den folgenden Themen werden die Replikationsprobleme beschrieben, die das Upgrade auf [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] beeinflussen können. In den Themen werden Aktionen beschrieben, mit denen Sie die Auswirkungen dieser Änderungen auf Ihre Umgebung reduzieren können.  
