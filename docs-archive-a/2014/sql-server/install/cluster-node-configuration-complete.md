...
-   Name dieses Knotens: Dieses Feld ist bereits mit dem Namen des Computers aufgefüllt, auf dem das [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Setup Programm ausgeführt wird.  
  
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Netzwerk Name des Failoverclusters: Dieses Feld ist nicht im Voraus ausgefüllt. Geben Sie den Netzwerknamen für die neue Instanz des [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Failoverclusters an. Anhand dieses Namens wird die Failoverclusterinstanz im Netzwerk identifiziert.  
