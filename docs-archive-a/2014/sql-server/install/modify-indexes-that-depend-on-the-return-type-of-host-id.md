...
---
# <a name="modify-indexes-that-depend-on-the-return-type-of-host_id"></a>Ändern von Indizes, die vom Rückgabetyp von HOST_ID abhängen
  Die HOST_ID-Funktion gibt jetzt `char(10)` zurück.  
