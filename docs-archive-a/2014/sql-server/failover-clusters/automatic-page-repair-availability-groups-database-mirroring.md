...
##  <a name="page-types-that-cannot-be-automatically-repaired"></a><a name="UnrepairablePageTypes"></a>Seiten Typen, die nicht automatisch repariert werden können  
...
##  <a name="handling-io-errors-on-the-principalprimary-database"></a><a name="PrimaryIOErrors"></a>Behandeln von e/a-Fehlern in der Prinzipal Datenbank/primären Datenbank  
...
##  <a name="handling-io-errors-on-the-mirrorsecondary-database"></a><a name="SecondaryIOErrors"></a>Behandeln von e/a-Fehlern in der Spiegel Datenbank/sekundären Datenbank  
...
##  <a name="developer-best-practice"></a><a name="DevBP"></a>Bewährte Methoden für Entwickler  
...
##  <a name="how-to-view-automatic-page-repair-attempts"></a><a name="ViewAPRattempts"></a>Vorgehensweise: Anzeigen von automatischen Seiten Reparaturversuchen  
