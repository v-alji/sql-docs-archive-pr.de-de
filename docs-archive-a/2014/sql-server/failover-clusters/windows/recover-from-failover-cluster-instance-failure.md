...
##  <a name="recover-from-an-irreparable-failure"></a><a name="Scenario1"></a>Wiederherstellung nach einem irreparablen Fehler  
...
##  <a name="recover-from-a-reparable-failure"></a><a name="Scenario2"></a>Wiederherstellen nach einem Fehler BEHEB baren Fehler  
