...
## <a name="ssnoversion-installation"></a>[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]-Installation  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Beginnen Sie mit der Produktdokumentation für die SQL Server](../index.yml) abwärts [Kompatibilität](backward-compatibility.md) .  
