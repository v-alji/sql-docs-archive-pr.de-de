...
# <a name="microsoft-sql-server-privacy-statement"></a>Datenschutzbestimmungen für Microsoft SQL Server
  Informationen zu den Komponenten zur Erfassung von Benutzerdaten in finden Sie in [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] den [SQL Server Datenschutzbestimmungen](https://go.microsoft.com/fwlink/?LinkID=282418).  
